    ...
    <drawer width="200px;" :show.sync="drawerVisibility" :show-mode="showMode" placement="left" :drawer-style="{'background-color':'#35495e', width: '200px'}">
      ...
      <div slot="drawer">
        <group title="Drawer demo(beta)" style="margin-top:20px;">
          ...
          <cell title="Buy me a coffee" link="project/donate" @click.native="drawerVisibility = false"></cell>
          <cell title="Github" link="http://github.com/airyland/vux" value="Star me" @click.native="drawerVisibility = false"></cell>
        </group>
      </div>
